...
let%test "test_issue5_state_var_external_fails" = test_typecheck 
...
let%test "test_issue5_state_var_public_ok" = test_typecheck 
...
let%test "test_issue6_receive_ok" = test_typecheck 
  "contract C { 
      receive() external payable {}  // CORRETTO: Niente parola 'function' prima
  }"
  true 

let%test "test_issue6_receive_fail_visibility" = test_typecheck 
  "contract C { 
      receive() public payable {}    // Errore: non è external
  }"
  false

let%test "test_issue6_receive_fail_mutability" = test_typecheck 
  "contract C { 
      receive() external {}          // Errore: non è payable
  }"
  false

let%test "test_issue6_other_function_ok" = test_typecheck 
  "contract C { 
